...
function LandingPage() {
  ...
  return (
    <div>
      ...
      <p className='mt-10 text-2xl mx-4'><span className='font-somibold text-2xl'>BIKAY</span> is the World's Shortest Link Shortener service to track, brand, and share short URLs.</p>
      </div>
      <div className='mt-10'>

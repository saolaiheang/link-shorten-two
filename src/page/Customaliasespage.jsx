...
function CustomAliasesPage() {
    ...
    const saveLinksToLocalStorageByUserId = (userId, links) => {
        if (userId) {
            ...
            <div className="flex w-full">
                ...
                <div className="w-full h-auto overflow-hidden ">
                    <div className="w-[60%] max-sm:w-[90%] max-sm:items-center h-10 m-auto mt-[131px] max-sm:mt-[50px]">
                        <h1 className="text-left text-[20px] py-4">Shorten a long URL</h1>               <div className="flex gap-4 w-[100%] h-[56.1px] max-sm:h-auto">
                            <input
                                type="text"
                                value={longUrl}
                            ...
                            <div className="w-full h-auto max-sm:h-auto flex max-sm:flex-col overflow-hidden bg-white shadow-lg rounded-lg p-2 max-sm:p-1 mt-[49px] border border-gray-300 max-sm:shadow-none max-sm:border-none max-sm:items-center">
                                ...
                                <div className="flex w-[100%] flex-wrap max-sm:flex-col">
                                    <div className="px-2 w-[80%] md:w[90%] xl:w-[80%] max-sm:w-[90%]">
                                        ...
                                        <p className="text-sm max-md:w-90 mt-2 text-left maxmd:text-center max-sm:text-center overflow-hidden font-medium break-words">
                                            {longUrl}
                                        </p>
                                    </div>
                        ...
                        <h1 className="text-left text-[20px] pt-8 pb-4">List of Custom Shortened Links</h1>
                        <div className="overflow-y-auto max-h-96 pr-2">
                            {links.length > 0 ? (
                                links.map((link, index) => (
                                    <div
                                        key={index}
                                        className="w-full h-auto max-sm:h-auto flex max-sm:flex-col overflow-hidden bg-white shadow-lg rounded-lg p-2 max-sm:p-1 mt-[49px] border border-gray-300 max-sm:shadow-none max-sm:border-none max-sm:items-center"
                                    >
                                        ...
                                        <div className="flex w-[100%] flex-wrap max-sm:flex-col">
                                            <div className="px-2 w-[80%] md:w[90%] xl:w-[80%] max-sm:w-[90%]">
                                                ...
                                                </p>                                                    <p className="text-sm max-md:w-90 min-md:w-60 max-lg:w-70 sm:text-sm md:text-xs mt-1 text-left max-sm:text-center max-sm:m-auto text-gray-500 break-words">{link.original_link}</p>
                                            </div>
                                            <div className="flex h-10 md:h-8 md:px-[30%] xl:px-1 xl:h-8 max-sm:h-8 max-sm:w-[5%] gap-2 max-sm:mt-3 max-sm:gap-1">
                                                <button
                                                    className="px-1 py-2 bg-gray-300 flex justify-center items-center max-sm:px-1 max-sm:py-1 rounded-[5px] text-white"
                                ...
                                <p>No custom shortened links available.</p>
                            )}
                        </div>
                    </div>
                </div>
